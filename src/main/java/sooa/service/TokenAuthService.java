...
public class TokenAuthService {
    ...
    public User registerUserService(User usuario) {
        return rest.postForObject("http://34.77.35.22:6664/register-user",
                usuario, User.class);
    }

    public User getUserService(String username) {
        return rest.getForObject("http://34.77.35.22:6664/user/un={username}",
                User.class, username);
    }


    public TokenLogin loginUserService ( LoginForm loginForm) {
        return rest.postForObject("http://34.77.35.22:6664/login",

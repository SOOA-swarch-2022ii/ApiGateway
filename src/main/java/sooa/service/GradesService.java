...
public class GradesService {
    ...
    public Grades getGrade(String id) {
        return rest.getForObject("http://localhost:4545/grade/{id}",
                Grades.class, id);
    }

    public Grades getGradeCourse(String subject, float grade) {
        return rest.getForObject("http://localhost:4545/grade/{id}/{grade}",
                Grades.class, subject, grade);
    }

    public List<Grades> getGrades() {
        return rest.getForObject("http://localhost:4545/grades",
                List.class);
    }
    ...
    public void updateGradeId(String id, String student, float grade) {
        ...
        rest.put("http://localhost:4545/grade/"+id+"/"+student+"/"+grade,null);
    }

    public void updateGradeCourse(String subject, int group, String student, float grade) {
        rest.put("http://localhost:4545/grade/"+subject+"/"+group+"/"+student+"/"+grade,null);
    }

    public void deleteGradeId(String id, String student, float grade) {
        rest.delete("http://localhost:4545/grade/{id}/{student}/{grade}",
                id,student, grade);
    }


    public void deleteGradeCourse(String subject, int group, String student, float grade) {
        rest.delete("http://localhost:4545/grade/{subject}/{group}/{student}/{grade}",

...
public class SubjectBrowserService {
    ...
    public Subject getSubjectById(String id) {
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/subjects/id={id}",
                Subject.class, id);
    }
    
    public Subject getSubjectByCode(String code) {
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/subjects/code={code}",
                Subject.class, code);
    }

    public Course getCourseById(String id){
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/courses/id={id}",
        Course.class, id);
    }

    public List<Course> getCoursesBySubject(String sb){
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/courses/sb={subject_code}",
        List.class, sb);
    }
    public List<Course> getCoursesByStudent(String st){
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/courses/st={student}",
        List.class, st);
    }
    public List<Course> getCoursesBySubjectSem(String sb, int semester){
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/courses/sb={student}/sm={semester}",
        List.class, sb,semester);
    }

    public List<Course> getCoursesByProfessor(String prof){
        return rest.getForObject("http://sooa-sb-container:6666/sooa-sb-ms/courses/profe={professor}",
        List.class, prof);
    }
